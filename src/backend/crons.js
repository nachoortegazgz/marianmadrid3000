 ...
 * VERSION: v19.6.15-pending-compensations-recovery
...
export async function verifyNightlyZClosing() {
    ...
    try {
        ...
        const yesterdayUtc = new Date(Date.UTC(nowUtc.getUTCFullYear(), nowUtc.getUTCMonth(), nowUtc.getUTCDate() - 1, 12, 0, 0));
        const diaKey = yesterdayUtc.toLocaleDateString('sv-SE', { timeZone: tz });
